...
window.renderer.showWelcomeMessage((event, account) => {
    console.log("🚀 ~ file: renderer.js:17 ~ window.renderer.showWelcomeMessage ~ account:", account)    
    if (!account) return;
...
const logout = document.querySelector('#signOut2')
...
const setProfile = (data) => {
    console.log("🚀 ~ file: renderer.js:47 ~ setProfile ~ data:", data)
    if (!data) return;
